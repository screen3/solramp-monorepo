...
export default function Home() {
    return (
        <>
            <Script src="http://localhost:5173/popup.js" strategy="beforeInteractive" />

            <Navbar />

            <main>
                <div className="bg-[#f0fff0] py-20 hero relative">
                            ...
                            <div className="text-center container max-w-3xl mx-auto">
                                ...
                                <div className="mt-5  ">
                                    <p className="text-base text-[#3F3F3F]">
                                        ...
                                        <br />
                                        Available for ReactJs, VueJs, Wordpress
                                        and Shopify websites.
                                        {/* Use our Algoramp SDK on your website,
