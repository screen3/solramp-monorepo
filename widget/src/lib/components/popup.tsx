import { Keys, PopupProps } from "../types";
import "../popup.css";
...
function OptionsSwitcher(props: { type: Keys; options: PopupProps }) {
    if (props.type === "bank") {
...
function QR({ options }: { options: PopupProps }) {
    ...
    return (
        <>
            ...
            <div className="">
                <p
                    className="main-description text-description"
                    style={{ textAlign: "center", color: "#676d72" }}
                >
                    Scan the QR code below in your Solana wallet to complete the
                    payment.
                </p>
            </div>
            <div
    ...
    return (
        <>
            <div className="main-body-title">
                Pay with Wise (formerly TransferWise)
            </div>
...
function BankTransfer({ options }: { options: PopupProps }) {
    ...
    return (
        <>
            ...
            <button className="main-button-transparent">
                I've sent the money
            </button>
        </>
    );
...
function NavButton(props: Method) {
    return (
        <button className={"payment-method-button"} onClick={props.handleClick}>
